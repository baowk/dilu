...
type GenColumn struct {
	...
	FkCol              []GenColumn `gorm:"-" json:"fkCol"`
...
func (e *GenColumn) GetList(tx *gorm.DB, exclude bool) ([]GenColumn, error) {
	var doc []GenColumn
...
func (e *GenColumn) Update(tx *gorm.DB) (update GenColumn, err error) {
